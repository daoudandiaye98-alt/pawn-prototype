 ...
 * kein zweites Landing, keine Navigation, kein Dashboard. Sechs Fehler korrigiert: die Kette ist
 * jetzt eine stille Hairline-Zeile statt eines zweiten Hero, es gibt genau einen CTA ("Mach deinen
 * Zug" → /start) statt drei verstreuter Buttons, keine Kategorien-Kacheln, kein Zählerblock mit
 * n=1-Statistik-Rhetorik. Die Seite endet allein stehend mit "PLAY YOUR OWN GAME."
 * Alle Texte hängen an site_content (Editable), damit sie ohne Code änderbar sind — mit
 * Ausnahme der drei englischen Marken-Zeilen (Positionierungssatz, Kette, Schlusssatz), die wie
      ...
      <section className="border-b-[1.5px] border-black px-6 py-16 text-center md:px-14 md:py-24">
        <Reveal>
          <p className="mx-auto max-w-[36ch] font-serif text-[clamp(1.5rem,3.6vw,2.6rem)] italic leading-[1.4] text-black">
            <Editable contentKey="vision_haltung" multiline>
              PAWN sagt nie: Wir machen dich zum Künstler. PAWN sagt: Du bist dran.
            </Editable>
          </p>
          <Link
            to="/start"
          ...
          >
            <Editable as="span" contentKey="vision_cta">Mach deinen Zug</Editable>
          </Link>
        </Reveal>
      </section>
