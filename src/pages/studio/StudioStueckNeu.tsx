          ...
          <>
            <div className="border-[1.5px] border-foreground bg-white p-6">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                ...
                <Link to="/studio/werke" className="border border-border px-4 py-2 text-[0.65rem] uppercase tracking-[0.24em] hover:bg-muted">{t("studio.stueckNeu.live.toCollection")}</Link>
              </div>
