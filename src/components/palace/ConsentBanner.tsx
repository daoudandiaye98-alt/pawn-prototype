      ...
      <div className="mx-auto max-w-4xl border border-[rgba(12,12,14,.18)] bg-white shadow-[0_16px_48px_-24px_rgba(12,12,14,0.35)]">
        <div className="grid gap-6 p-6 md:grid-cols-[1.4fr_auto] md:items-center md:p-8">
          <div>
            ...
            <p className="palace-serif mt-3 text-[1.15rem] leading-[1.35] text-[#0C0C0E]">
            ...
            <p className="mt-3 text-[0.9rem] leading-[1.6] text-[#0C0C0E]/75">
          ...
          <div className="flex flex-col gap-2 md:min-w-[220px]">
            <button
              ...
              className="palace-btn justify-center bg-[#0C0C0E] text-[#F1EEE7]"
            >
            ...
            {decided && (
              <button
                ...
                className="palace-eyebrow mt-1 text-[#6B6862] hover:text-[#0C0C0E]"
              >
                Schließen
              </button>
            )}
