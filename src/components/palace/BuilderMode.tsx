...
export function BuilderToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-6 z-[80] flex items-center gap-2 border border-black/60 bg-white/95 px-4 py-2 text-[0.62rem] uppercase tracking-[0.32em] text-black shadow-hard-sm backdrop-blur transition hover:bg-white"
    >
