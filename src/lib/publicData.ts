...
const SEED_COLLECTION: PublicCollection = {
  ...
  items: [
    ...
    { product_slug: "draped-hoodie", world: "Mode", sort: 1 },
    { product_slug: "silk-structure-shirt", world: "Mode", sort: 2 },
    { product_slug: "contour-jacket", world: "Mode", sort: 3 },
    { product_slug: "double-waist-jeans", world: "Mode", sort: 4 },
    { product_slug: "wire-bag", world: "Mode", sort: 5 },
    { product_slug: "oyu-bench", world: "Interior", sort: 6 },
    { product_slug: "oyu-lamp", world: "Interior", sort: 7 },
    { product_slug: "oyu-mirror", world: "Interior", sort: 8 },
    { product_slug: "kaja-canvas-i", world: "Kunst", sort: 9 },
    { product_slug: "kaja-canvas-ii", world: "Kunst", sort: 10 },
    { product_slug: "noor-tapestry", world: "Kunst", sort: 11 },
  ],
};
